...
namespace EndToEndMailCourse._03
{
    ...
    public class Workshop03Tests
    {
        ...
        public void ShouldCheckSelectedBookName()
        {
            ...
            #region TEST CODE
            book = driver.FindElement(By.CssSelector(" .row .books > .list-group > .selected h4"));
            #endregion
        ...
        public void ShouldCheckNumberOfBooks()
        {
            ...
            #region TEST CODE
            books = driver.FindElements(By.CssSelector(".row .books > .list-group > .book"));
            #endregion
        ...
        public void ShouldCheckLinksDomain()
        {
            ...
            #region TEST CODE
            links = driver.FindElements(By.CssSelector(".row .books > .list-group > .book .btn.btn-default"));
            #endregion
